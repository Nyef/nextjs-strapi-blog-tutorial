    ...
    async getBlogPost(_: string) {
        return {
            ...
            content: "" +
                ...
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac felis nisi. Mauris in lacus auctor, venenatis erat ac, congue magna.\n" +
                "\n" +
                "![eerste-duik-in-python-van-javascript-developer/cover-600x.png](https://nyef.nl/blog/eerste-duik-in-python-van-javascript-developer/cover-600x.png)\n",
            seoMetadata: {
